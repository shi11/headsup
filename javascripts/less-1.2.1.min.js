...
(function (a, b) {
    ...
    function o(b, c, e, f) {
        ...
        s(b.href, b.type, function (a, g) {
                if (!e && l && g && (new Date(g)).valueOf() === (new Date(l.timestamp)).valueOf()) r(l.css, b),
                    c(null, b, {
                        local: !0,
                        remaining: f
                    });
                else try { (new d.Parser({
    ...
    function s(a, b, c, e) {
        ...
        var f = t(),
            h = g ? !1 : d.async;
        typeof f.overrideMimeType == "function" && f.overrideMimeType("text/css"),
            f.open("GET", a, h),
            f.setRequestHeader("Accept", b || "text/x-less, text/css; q=0.9, */*; q=0.5"),
            f.send(null),
            g ? f.status === 0 || f.status >= 200 && f.status < 300 ? c(f.responseText) : e(f.status, a) : h ? f.onreadystatechange = function () {
    ...
    function t() {
        ...
        try {
            ...
            return v("browser doesn't support AJAX."),
                null
        }
    }
    function u(a) {
    ...
    function w(a, b) {
        var c = "less-error-message:" + q(b),
            ...
            j = a.filename || b;
        f.id = c,
            f.className = "less-error-message",
            h = "<h3>" + (a.message || "There is an error in your .less file") + "</h3>" + '<p>in <a href="' + j + '">' + j + "</a> ";
        var k = function (a, b, c) {
            a.extract[b] && i.push(e.replace(/\{line\}/, parseInt(a.line) + (b - 1)).replace(/\{class\}/, c).replace(/\{content\}/, a.extract[b]))
        };
        a.stack ? h += "<br/>" + a.stack.split("\n").slice(1).join("<br/>") : a.extract && (k(a, 0, ""), k(a, 1, "line"), k(a, 2, ""), h += "on line " + a.line + ", column " + (a.column + 1) + ":</p>" + "<ul>" + i.join("") + "</ul>"),
            f.innerHTML = h,
            r([".less-error-message ul, .less-error-message li {", "list-style-type: none;", "margin-right: 15px;", "padding: 4px 0;", "margin: 0;", "}", ".less-error-message label {", "font-size: 12px;", "margin-right: 15px;", "padding: 4px 0;", "color: #cc7777;", "}", ".less-error-message pre {", "color: #dd6666;", "padding: 4px 0;", "margin: 0;", "display: inline-block;", "}", ".less-error-message pre.line {", "color: #ff0000;", "}", ".less-error-message h3 {", "font-size: 20px;", "font-weight: bold;", "padding: 15px 0 5px 0;", "margin: 0;", "}", ".less-error-message a {", "color: #10a", "}", ".less-error-message .error {", "color: red;", "font-weight: bold;", "padding-bottom: 2px;", "border-bottom: 1px dashed red;", "}"].join("\n"), {
                title: "error-message"
            }),
            f.style.cssText = ["font-family: Arial, sans-serif", "border: 1px solid #e00", "background-color: #eee", "border-radius: 5px", "-webkit-border-radius: 5px", "-moz-border-radius: 5px", "color: #e00", "padding: 15px", "margin-bottom: 15px"].join(";"),
            d.env == "development" && (g = setInterval(function () {
    ...
    var d, f;
    typeof environment == "object" && {}.toString.call(environment) === "[object Environment]" ? (typeof a == "undefined" ? d = {}: d = a.less = {},
        f = d.tree = {},
        d.mode = "rhino") : typeof a == "undefined" ? (d = exports, f = c("./tree"), d.mode = "node") : (typeof a.less == "undefined" && (a.less = {}), d = a.less, f = a.less.tree = {},
        d.mode = "browser"),
        d.Parser = function (b) {
            function t() {
                j = m[i],
            ...
            function w(a) {
                ...
                if (typeof a == "string") b = g.charAt(h) === a ? a: null,
                    d = 1,
                    v();
                else {
                    v();
                ...
                if (b) {
                    ...
                    return m[i] = m[i].slice(d + (h - l)),
                        n = h,
                        m[i].length === 0 && i < m.length - 1 && i++,
                        typeof b == "string" ? b: b.length === 1 ? b[0] : b
                }
            }
            function x(a, b) {
                var c = w(a);
            ...
            function C(a, b) {
                ...
                this.type = a.type || "Syntax",
                    ...
                    this.filename = a.filename || b.filename,
                    this.index = a.index,
                    this.line = typeof e == "number" ? e + 1 : null,
                    this.callLine = a.call && B(a.call, c) + 1,
                    this.callExtract = g[B(a.call, c)],
                    this.stack = a.stack,
                    this.column = f,
                    this.extract = [g[e - 1], g[e], g[e + 1]]
            }
            var g, h, i, j, k, l, m, n, o, q = this,
                ...
                s = this.imports = {
                    ...
                    push: function (a, c) {
                        var e = this;
                        this.queue.push(a),
                            d.Parser.importer(a, this.paths, function (b, d, f) {
                                    e.queue.splice(e.queue.indexOf(a), 1),
                                        e.files[a] = d,
                                        e.contents[a] = f,
                                        b && !e.error && (e.error = b),
                                        c(b, d),
            ...
            return this.env = b = b || {},
                ...
                o = {
                    ...
                    parse: function (a, e) {
                        ...
                        h = i = n = l = 0,
                            ...
                            m = function (a) {
                                ...
                                for (var l = 0, m, n; l < g.length; l++) {
                                    d.lastIndex = l,
                                        (h = d.exec(g)) && h.index === l && (l += h[0].length, i.push(h[0])),
                                        m = g.charAt(l),
                                        e.lastIndex = l,
                                        !k && !j && m === "/" && (n = g.charAt(l + 1), (n === "/" || n === "*") && (h = e.exec(g)) && h.index === l && (l += h[0].length, i.push(h[0]), m = g.charAt(l)));
                                    if (m === "{" && !k && !j) f++,
                                        i.push(m);
                                    else if (m === "}" && !k && !j) f--,
                                        i.push(m),
                                        a[++c] = i = [];
                                    else if (m === "(" && !k && !j) i.push(m),
                                        j = !0;
                                    else if (m === ")" && !k && j) i.push(m),
                                        j = !1;
                                    else {
                        ...
                        try {
                            j = new f.Ruleset([], w(this.parsers.primary)),
                                j.root = !0
                        } catch(y) {
                            return e(new C(y, b))
                        }
                        j.toCSS = function (a) {
                            ...
                            return function (e, g) {
                                var h = [],
                                    i;
                                e = e || {},
                                    typeof g == "object" && !Array.isArray(g) && (g = Object.keys(g).map(function (a) {
                                        var b = g[a];
                                        return b instanceof f.Value || (b instanceof f.Expression || (b = new f.Expression([b])), b = new f.Value([b])),
                                            new f.Rule("@" + a, b, !1, 0)
                    ...
                    parsers: {
                        ...
                        entities: {
                            ...
                            url: function () {
                                ...
                                return a = w(this.entities.quoted) || w(this.entities.variable) || w(this.entities.dataURI) || w(/^[-\w%@$\/.&=:;#+?~]+/) || "",
                                    x(")"),
                                    new f.URL(a.value || a.data || a instanceof f.Variable ? a: new f.Anonymous(a), s.paths)
                            },
                            dataURI: function () {
                                var a;
                                if (w(/^data:/)) {
                        ...
                        mixin: {
                            call: function () {
                                var a = [],
                                    ...
                                    k = !1;
                                if (j !== "." && j !== "#") return;
                                while (c = w(/^[#.](?:[\w-]|\\(?:[a-fA-F0-9]{1,6} ?|[^a-fA-F0-9]))+/)) a.push(new f.Element(d, c, h)),
                                    d = w(">");
                                w("(") && (e = w(this.entities.arguments)) && w(")"),
                                    w(this.important) && (k = !0);
                            ...
                            definition: function () {
                                ...
                                if (c = w(/^([#.](?:[\w-]|\\(?:[a-fA-F0-9]{1,6} ?|[^a-fA-F0-9]))+)\s*\(/)) {
                                    ...
                                    x(")"),
                                        w(/^when/) && (j = x(this.conditions, "expected condition")),
                                        d = w(this.block);
                        ...
                        alpha: function () {
                            ...
                            if (a = w(/^\d+/) || w(this.entities.variable)) return x(")"),
                                new f.Alpha(a)
                        },
                        element: function () {
                            var a, b, c, d;
                            c = w(this.combinator),
                                a = w(/^(?:\d+\.\d+|\d+)%/) || w(/^(?:[.#]?|:*)(?:[\w-]|\\(?:[a-fA-F0-9]{1,6} ?|[^a-fA-F0-9]))+/) || w("*") || w(this.attribute) || w(/^\([^)@]+\)/),
                                a || w("(") && (d = w(this.entities.variable)) && w(")") && (a = new f.Paren(d));
                        ...
                        rule: function () {
                            ...
                            if (a = w(this.variable) || w(this.property)) {
                                a.charAt(0) != "@" && (e = /^([^@+\/'"*`(;{}-]*);/.exec(m[i])) ? (h += e[0].length - 1, b = new f.Anonymous(e[1])) : a === "font" ? b = w(this.font) : b = w(this.value),
                                    d = w(this.important);
                        ...
                        condition: function () {
                            ...
                            w(/^not/) && (g = !0),
                                x("(");
                            if (a = w(this.addition) || w(this.entities.keyword) || w(this.entities.quoted)) return (d = w(/^(?:>=|=<|[<=>])/)) ? (b = w(this.addition) || w(this.entities.keyword) || w(this.entities.quoted)) ? c = new f.Condition(d, a, b, e, g) : y("expected expression") : c = new f.Condition("=", a, new f.Keyword("true"), e, g),
                                x(")"),
                                w(/^and/) ? new f.Condition("and", c, w(this.condition)) : c
                        },
                        operand: function () {
    ...
    (function (a) {
        ...
        a.functions = {
            ...
            hsla: function (a, b, d, e) {
                function h(a) {
                    return a = a < 0 ? a + 1 : a > 1 ? a - 1 : a,
                        a * 6 < 1 ? g + (f - g) * a * 6 : a * 2 < 1 ? f: a * 3 < 2 ? g + (f - g) * (2 / 3 - a) * 6 : g
                }
                a = c(a) % 360 / 360,
                    b = c(b),
                    d = c(d),
            ...
            escape: function (b) {
                return new a.Anonymous(encodeURI(b.value).replace(/=/g, "=").replace(/:/g, ":").replace(/#/g, "#").replace(/;/g, ";").replace(/\(/g, "(").replace(/\)/g, ")"))
            },
            "%": function (b) {
        ...
        function (a) {
            a.Alpha = function (a) {
                ...
                a.Alpha.prototype = {
                    ...
                    eval: function (a) {
                        return this.value.eval && (this.value = this.value.eval(a)),
                            this
                    }
                }
        } (c("../tree")),
        ...
        function (a) {
            a.Directive = function (b, c, d) {
                this.name = b,
                    this.features = d && new a.Value(d),
                    Array.isArray(c) ? (this.ruleset = new a.Ruleset([], c), this.ruleset.allowImports = !0) : this.value = c
            },
                a.Directive.prototype = {
                    ...
                    eval: function (a) {
                        return this.features = this.features && this.features.eval(a),
                            a.frames.unshift(this),
                            this.ruleset = this.ruleset && this.ruleset.eval(a),
                            a.frames.shift(),
                            this
                    },
                    variable: function (b) {
        ...
        function (a) {
            a.Element = function (b, c, d) {
                this.combinator = b instanceof a.Combinator ? b: new a.Combinator(b),
                    typeof c == "string" ? this.value = c.trim() : c ? this.value = c: this.value = "",
                    this.index = d
            },
        ...
        function (a) {
            a.Import = function (b, c, d, e) {
                ...
                this.index = e,
                    this._path = b,
                    this.features = d && new a.Value(d),
                    b instanceof a.Quoted ? this.path = /\.(le?|c)ss(\?.*)?$/.test(b.value) ? b.value: b.value + ".less": this.path = b.value.value || b.value,
                    this.css = /css(\?.*)?$/.test(this.path),
                    this.css || c.push(this.path, function (b, c) {
                        b && (b.index = e),
                            f.root = c || new a.Ruleset([], [])
                    })
            },
                a.Import.prototype = {
                    toCSS: function (a) {
        ...
        function (a) {
            a.mixin = {},
                    ...
                    eval: function (a) {
                        ...
                        for (var f = 0; f < a.frames.length; f++) if ((b = a.frames[f].find(this.selector)).length > 0) {
                            ...
                            for (var g = 0; g < b.length; g++) if (b[g].match(c, a)) try {
                                Array.prototype.push.apply(d, b[g].eval(a, this.arguments, this.important).rules),
                                    e = !0
                            } catch(h) {
                                throw {
                                    message: h.message,
                ...
                a.mixin.Definition = function (b, c, d, e) {
                    this.name = b,
                        this.selectors = [new a.Selector([new a.Element(null, b)])],
                        this.params = c,
                        this.condition = e,
                        this.arity = c.length,
                        this.rules = d,
                ...
                a.mixin.Definition.prototype = {
                    ...
                    eval: function (b, c, d) {
                        ...
                        return e.rules.unshift(new a.Rule("@arguments", (new a.Expression(g)).eval(b))),
                            h = d ? this.rules.map(function (b) {
                                return new a.Rule(b.name, b.value, "!important", b.index)
                            }) : this.rules.slice(0),
                            (new a.Ruleset(null, h)).eval({
        ...
        function (a) {
            a.Rule = function (b, c, d, e, f) {
                this.name = b,
                    ...
                    this.index = e,
                    this.inline = f || !1,
                    b.charAt(0) === "@" ? this.variable = !0 : this.variable = !1
            },
            ...
            a.Ruleset = function (a, b) {
                ...
                a.Ruleset.prototype = {
                    eval: function (b) {
                        ...
                        for (var e = 0, f; e < d.rules.length; e++) f = d.rules[e],
                            f instanceof a.mixin.Definition || (d.rules[e] = f.eval ? f.eval(b) : f);
                        return b.frames.shift(),
                            d
                    },
                    match: function (a) {
                        return ! a || a.length === 0
                    ...
                    toCSS: function (b, c) {
                        ...
                        for (var j = 0; j < this.rules.length; j++) i = this.rules[j],
                            i.rules || i instanceof a.Directive ? f.push(i.toCSS(g, c)) : i instanceof a.Comment ? i.silent || (this.root ? f.push(i.toCSS(c)) : e.push(i.toCSS(c))) : i.toCSS && !i.variable ? e.push(i.toCSS(c)) : i.value && !i.variable && e.push(i.value.toString());
                        return f = f.join(""),
                            this.root ? d.push(e.join(c.compress ? "": "\n")) : e.length > 0 && (h = g.map(function (a) {
                                return a.map(function (a) {
                                    return a.toCSS(c)
                                }).join("").trim()
                    ...
                    joinSelector: function (b, c, d) {
                        var e = [],
                            ...
                            i = !1,
                            j;
                        for (var k = 0; k < d.elements.length; k++) j = d.elements[k],
                            j.combinator.value.charAt(0) === "&" && (i = !0),
                            i ? h.push(j) : g.push(j);
                        i || (h = g, g = []),
                            g.length > 0 && e.push(new a.Selector(g)),
                            h.length > 0 && f.push(new a.Selector(h));
    ...
    d.env = d.env || (location.hostname == "127.0.0.1" || location.hostname == "0.0.0.0" || location.hostname == "localhost" || location.port.length > 0 || g ? "development": "production"),
        d.async = !1,
        d.poll = d.poll || (g ? 1e3: 1500),
        d.watch = function () {
    ...
    d.refresh = function (a) {
        ...
        b = c = new Date,
            n(function (a, d, e, f, g) {
                    g.local ? v("loading " + f.href + " from cache.") : (v("parsed " + f.href + " successfully."), r(d.toCSS(), f, g.lastModified)),
                        v("css for " + f.href + " generated in " + (new Date - c) + "ms"),
                        g.remaining === 0 && v("css generated in " + (new Date - b) + "ms"),
                        c = new Date
                },
                a),
            m()
